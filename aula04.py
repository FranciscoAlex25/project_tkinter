...
class Application(Main):
    ...
    def botoes(self):
        ...
        self.btncadastrar = Button(self.frame1, text='cadastrar', bg='lightgreen')
        self.btncadastrar.place(relx=0.42, rely=0.05, relwidth=0.15, relheight=0.15)

        self.btnatualizar = Button(self.frame1, text='atualizar', bg='blue')
        self.btnatualizar.place(relx=0.58, rely=0.05, relwidth=0.15, relheight=0.15)

        self.btnapagar = Button(self.frame1, text='apagar', bg='red')
    ...
    def tabela(self):
        ...
        self.tabela.column('cidade', minwidth=0, width=100)
        self.tabela.column('telefone', minwidth=0, width=100)
        ...
        # self.tabela.insert('', 'end', values=(1, 'alex', 'pereiro', '(88)996894193'))
